...
[CreateAssetMenu(fileName = "ActiveDetailViewerSwitch", menuName = "ScriptableObjects/UIData/ActiveDetailViewerSwitch", order = 1)]
public class ActiveDetailViewerSwitch : ScriptableObject
{
    ...
    public string ReturnActiveDescriptionOnlyFromName(string activeName)
    {
        dummyActive.LoadSkillFromString(activeData.ReturnValue(activeName));
        return ReturnActiveEffectDescriptions(dummyActive);
    }
    ...
    public string AED(string e, string s, string p)
    {
        ...
        switch (e)
        {
            ...
            case "TargetAllies":
                return "Target allies gain " + APD(p) + " " + ASD(s) + ".";
            case "AllEnemies":
            ...
            case "ChainLightningAttack":
                return "Lightning strikes to attack the target and bounces to nearby enemies within " + s + " tiles, and bounces to up to " + p + " different enemies.";
            case "Invisible":
        ...
        return passiveDetails.PassiveEffect(e, s, "Target");
    }
